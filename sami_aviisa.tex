...
\begin{tabular}{llrrrr}
 & & \textbf{\ds{Train+Wiki}, 6-gram} & & \textbf{\ds{Big}, 10-gram}\\
\textbf{Language} & \textbf{Voice} & \textbf{WER} & \textbf{LER}& \textbf{{WER}} & \textbf{LER}\\\hline
Estonian & EF1 & 39.6 & 15.8  &  & \\
Estonian & EM1 & 44.0 & 16.5& & \\
...
& & & \textbf{4-gram} & & \textbf{max-gram} &\\
\textbf{Language} & \textbf{Voice} & \textbf{\#hours} & \textbf{WER} & \textbf{LER}& \textbf{{WER}} & \textbf{LER} & \textbf{\%+ hours} & \textbf{-WER/hour} \\\hline
Estonian & EF1 & 8 & 20.8  & 8.8 & 18.8 & 8.3 & &  \\
Estonian & EM1 & 4.5 & 38.9  & 12.6   & 37.7  & 12.2& &  \\
